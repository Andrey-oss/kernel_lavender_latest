cmd_scripts/dtc/yamltree.o := gcc -Wp,-MD,scripts/dtc/.yamltree.o.d -Iscripts/dtc -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89 -pipe  -I../scripts/dtc/libfdt -c -o scripts/dtc/yamltree.o ../scripts/dtc/yamltree.c
