...
ifneq "$(KERNELVERSION)" "4.19.210"
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "aarch64-elf-gcc-12.0.1 (Mystic GCC) 12.0.1 20220428 (experimental)"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" ".."
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "/root/kernel/gcc-arm64-main/bin/aarch64-elf-gcc-12.0.1"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "/root/kernel/gcc-arm64-main/bin/aarch64-elf-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "/root/kernel/gcc-arm64-main/bin/aarch64-elf-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "/root/kernel/gcc-arm64-main/bin/aarch64-elf-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
